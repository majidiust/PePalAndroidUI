...
public class ContactProfileActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int width = (int) This.getResources().getDimension(org.pepal.R.dimen.user_profile_thumbnail_size);
		Picasso.with(This).load(SettingSchema.mBaseRestUrl + "uploaded/profiles/" + userId + ".png").resize(width, width)
		  .centerInside().placeholder(org.pepal.R.drawable.ic_default_user_picture).error(org.pepal.R.drawable.ic_default_user_picture).into(mProfileImage);
	}
